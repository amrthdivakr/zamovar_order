...
var _setStyle = require("../../utils/set-style");
...
function () {
  ...
  Bounce.prototype.render = function (_a) {
    ...
    (0, _setStyle.setStyle)(contentEl, {
    ...
    if (x) {
      ...
      (0, _setStyle.setStyle)(track.xAxis.thumb.element, {
    ...
    if (y) {
      ...
      (0, _setStyle.setStyle)(track.yAxis.thumb.element, {
...
},{"../../utils/set-style":"node_modules/smooth-scrollbar/utils/set-style.js"}],"node_modules/smooth-scrollbar/plugins/overscroll/glow.js":[function(require,module,exports) {
"use strict";
...
function () {
  function Glow(_scrollbar) {
    ...
    (0, _setStyle.setStyle)(this._canvas, {
      position: 'absolute',
      top: 0,
      left: 0,
      width: '100%',
  ...
  Glow.prototype._renderX = function (strength) {
    ...
    var opacity = (0, _clamp.default)(Math.abs(strength) / maxOverscroll, 0, GLOW_MAX_OPACITY);
    var startOffset = (0, _clamp.default)(opacity, 0, GLOW_MAX_OFFSET) * width; // controll point
...
exports.Glow = Glow;
},{"lodash-es/clamp":"node_modules/lodash-es/clamp.js","../../utils/set-style":"node_modules/smooth-scrollbar/utils/set-style.js"}],"node_modules/smooth-scrollbar/plugins/overscroll/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.OverscrollEffect = void 0;
...
var _glow2 = require("./glow");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var OverscrollEffect;
exports.OverscrollEffect = OverscrollEffect;

(function (OverscrollEffect) {
  OverscrollEffect["BOUNCE"] = "bounce";
  OverscrollEffect["GLOW"] = "glow";
})(OverscrollEffect || (exports.OverscrollEffect = OverscrollEffect = {}));
...
/** @class */
function (_super) {
  (0, _tslib.__extends)(OverscrollPlugin, _super);

  function OverscrollPlugin() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this._glow = new _glow2.Glow(_this.scrollbar);
    _this._bounce = new _bounce.Bounce(_this.scrollbar);
    ...
    _this._releaseWheel = (0, _debounce.default)(function () {
  ...
  OverscrollPlugin.prototype._willOverscroll = function (direction, delta) {
    ...
    return (0, _clamp.default)(offset + delta, 0, limit) === offset && (offset === 0 || offset === limit);
  };
  ...
  OverscrollPlugin.prototype._absorbMomentum = function (direction, remainMomentum) {
    ...
    _amplitude[direction] = (0, _clamp.default)(remainMomentum, -options.maxOverscroll, options.maxOverscroll);
  };
  ...
  OverscrollPlugin.prototype._addAmplitude = function (direction, delta) {
    ...
    /*    top | left  */
    (0, _clamp.default)(amp, -options.maxOverscroll, 0) :
    /* bottom | right */
    (0, _clamp.default)(amp, 0, options.maxOverscroll);
  ...
  OverscrollPlugin.prototype._render = function () {
    ...
    if (this._enabled && (_amplitude.x || _amplitude.y || _position.x || _position.y)) {
      ...
      if (typeof options.onScroll === 'function') {
        options.onScroll.call(this, (0, _tslib.__assign)({}, _position));
      }
    }
  };
...
var _default = OverscrollPlugin;
exports.default = _default;
},{"tslib":"node_modules/tslib/tslib.es6.js","lodash-es/clamp":"node_modules/lodash-es/clamp.js","lodash-es/debounce":"node_modules/lodash-es/debounce.js","smooth-scrollbar":"node_modules/smooth-scrollbar/index.js","./bounce":"node_modules/smooth-scrollbar/plugins/overscroll/bounce.js","./glow":"node_modules/smooth-scrollbar/plugins/overscroll/glow.js"}],"HorizontalScrollPlugin.js":[function(require,module,exports) {
"use strict";
...
var HorizontalScrollPlugin = /*#__PURE__*/function (_Scrollbar$ScrollbarP) {
  _inherits(HorizontalScrollPlugin, _Scrollbar$ScrollbarP);

  var _super = _createSuper(HorizontalScrollPlugin);
...
exports.default = HorizontalScrollPlugin;
HorizontalScrollPlugin.pluginName = "horizontalScroll";
HorizontalScrollPlugin.defaultOptions = {
  events: []
};
},{"smooth-scrollbar":"node_modules/smooth-scrollbar/index.js"}],"Scroll.js":[function(require,module,exports) {
"use strict";
...
var _overscroll = _interopRequireDefault(require("smooth-scrollbar/plugins/overscroll"));

var _HorizontalScrollPlugin = _interopRequireDefault(require("./HorizontalScrollPlugin"));
...
_smoothScrollbar.default.use(_HorizontalScrollPlugin.default, _overscroll.default);
...
var Scroll = /*#__PURE__*/function () {
  ...
  _createClass(Scroll, [{
    key: "init",
    value: function init() {
      this.Scroll = _smoothScrollbar.default.init(document.querySelector(".bt-container"), {
        // delegateTo: document,
        continuousScrolling: false,
        overscrollEffect: "bounce",
        damping: 0.05,
        thumbMinSize: 0 // alwaysShowTracks: true,
        // plugins: {
        //   horizontalScroll: {
        //     events: [/wheel/],
        //   },
      ...
      _smoothScrollbar.default.detachStyle();
    }
  }]);
...
},{"smooth-scrollbar":"node_modules/smooth-scrollbar/index.js","smooth-scrollbar/plugins/overscroll":"node_modules/smooth-scrollbar/plugins/overscroll/index.js","./HorizontalScrollPlugin":"HorizontalScrollPlugin.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
(void 0).something = new _Scroll.default();
},{"./Scroll":"Scroll.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/zamovar_order.e31bb0bc.js.map